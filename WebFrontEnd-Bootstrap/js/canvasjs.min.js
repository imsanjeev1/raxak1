...
(function () {
    ...
    Y = {
        theme1: {
            ...
            Title: {
                fontFamily: t ? "Open Sans, Optima, Candara, Verdana, Geneva, sans-serif" : "calibri",
                fontSize: 33,
                fontColor: "#3A3A3A",
                fontWeight: "bold",
                verticalAlign: "top",
            ...
            Axis: {
                ...
                titleFontFamily: t ? "Open Sans, Optima, Candara, Verdana, Geneva, sans-serif" : "calibri",
                labelFontFamily: t ? "Open Sans, Optima, Candara, Verdana, Geneva, sans-serif" : "calibri",
                labelFontSize: 18,
                labelFontColor: "grey",
                tickColor: "#BBBBBB",
                tickThickness: 2,
            ...
            Legend: {
                ...
                horizontalAlign: "center",
                fontFamily: t ? "Open Sans, sans-serif,arial black" : "calibri"
            },
            DataSeries: {
                indexLabelFontColor: "grey",
                indexLabelFontFamily: t ? "Open Sans, Optima, Candara, Verdana, Geneva, sans-serif" : "calibri",
        ...
        theme2: {
            ...
            Axis: {
                ...
                titleFontFamily: t ? "Open Sans, sans-serif,arial black" : "arial",
                titleFontWeight: "bold",
                labelFontFamily: t ? "Open Sans, Courier New, Courier" : "arial",
                labelFontSize: 16,
                labelFontColor: "grey",
            ...
            Legend: {
                verticalAlign: "bottom",
                horizontalAlign: "center",
                fontFamily: t ? "Open Sans, sans-serif,arial black" : "arial"
            },
            DataSeries: {
                indexLabelFontColor: "grey",
                indexLabelFontFamily: t ? "Courier New, Courier, Open Sans" : "arial",
        ...
        theme3: {
            ...
            Axis: {
                titleFontSize: 22,
                titleFontColor: "rgb(98,98,98)",
                titleFontFamily: t ? "Open Sans, sans-serif" : "calibri",
                labelFontFamily: t ? "Open Sans, Optima, Candara, Verdana, Geneva, sans-serif" : "calibri",
                labelFontSize: 18,
                labelFontColor: "grey",
                tickColor: "grey",
            ...
            DataSeries: {
                bevelEnabled: !0,
                indexLabelFontColor: "grey",
                indexLabelFontFamily: t ? "Open Sans, Verdana, Geneva, sans-serif" : "calibri",
                indexLabelFontSize: 18,
    ...
    u.prototype._updateOptions =
            function () {
                ...
                if (!this._dropdownMenu && this.exportEnabled &&
                    ...
                    this._dropdownMenu.style.cssText = "position: absolute; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; cursor: pointer;right: 1px;top: 25px;min-width: 120px;outline: 0;border: 1px solid silver;font-size: 14px;font-family: Open Sans, Verdana, sans-serif;padding: 5px 0px 5px 0px;text-align: left;background-color: #fff;line-height: 20px;box-shadow: 2px 2px 10px #888888;";
    ...
    R.prototype._initialize = function () {
        if (this.enabled) {
            ...
            a += "padding: 5px;";
            a += "font-family: Open Sans, Arial, Georgia, serif;";
                ...
                if (f = "", f = this.getToolTipInnerHTML({
                    ...
                    try {
                        this.contentDiv.style.background = this.backgroundColor ? this.backgroundColor :
                                ...
                                0 === this.cornerRadius ? this.cornerRadius + "px" : "5px", this.container.style.borderRadius = this.contentDiv.style.borderRadius, this.contentDiv.style.fontSize = this.fontSize || 0 === this.fontSize ? this.fontSize + "px" : "14px", this.contentDiv.style.color = this.fontColor ? this.fontColor : "#000000", this.contentDiv.style.fontFamily = this.fontFamily ? this.fontFamily : "Open Sans, Arial, Georgia, serif;", this.contentDiv.style.fontWeight = this.fontWeight ? this.fontWeight : "normal", this.contentDiv.style.fontStyle = this.fontStyle ? this.fontStyle :
                                t ? "italic" : "normal"
                    } catch (k) {
                    }
