...
function _MakePWDWidget() {
    ...
    code += "<input type='password' class='pwdfield form-control' name='" + pwdname + "' id='" + this.pwdfieldid + "' placeholder='New Password'>";

    this.pwdtxtfield = pwdname + "_text";

    this.pwdtxtfieldid = this.pwdtxtfield + "_id";

    code += "<input type='text' class='pwdfield form-control' name='" + this.pwdtxtfield + "' id='" + this.pwdtxtfieldid + "' style='display: none;' placeholder='New Password'>";
