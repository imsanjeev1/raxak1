...
(function (C, Y) {
        ...
        for (var c = "{", d = !1, e, f, g, h, i, k = [];
            ...
            if (d) {
                ...
                for (h = 0; h < i; h++)
                    e = e[g[h]];
                if (f.length)
                    f = f.join(":"), g = /\.([0-9])/, h = O.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e !== null && (e = u.numberFormat(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))) : e = Ra(f, e)
            }
            k.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" : "{"
    ...
    qb.prototype = {
        ...
        step: function (a) {
            ...
            if (c.attr && !c.element)
                ...
                this.pos = d.easing((b - this.startTime) / f), this.now = this.start + (this.end - this.start) *
        ...
        initPath: function (a, b, c) {
            ...
            if (b.length)
                for (a = c.length; b.length < a; )
                    d = [].concat(b).splice(b.length - f, f), e && (d[f - 6] = d[f -
    ...
    U = function (a, b, c) {
        ...
        var f, g = a.hcEvents,
                h;
        if (g)
            b ? (f = g[b] || [], c ? (h = qa(c, f), h > -1 && (f.splice(h, 1), g[b] = f), d(b, c)) : (e(), g[b] = [])) : (e(), a.hcEvents = {})
    };
    H = function (a, b, c, d) {
        var e;
        e = a.hcEvents;
    ...
    if (C.jQuery)
        C.jQuery.fn.highcharts = function () {
            ...
            if (this[0])
                return a[0] ? (new (u[ya(a[0]) ? a.shift() : "Chart"])(this[0], a[0], a[1]), this) : W[L(this[0], "data-highcharts-chart")]
        };
    z && !z.defaultView && (Ga = function (a, b) {
        ...
        b === "opacity" && (b = "filter");
        if (c)
            return a.style.zoom = 1, a[c] - 2 * Ga(a, "padding");
    ...
    u.stop = Pa;
    O = {
        colors: "#7cb5ec,#ff9900,#90ed7d,#f7a35c,#8085e9,#f15c80,#e4d354,#2b908f,#f45b5b,#91e8e1".split(","),
...
//            headerFormat: '<span style="font-size: 10px">{point.key}</span><br/>',
            headerFormat: '<span style="font-size: 10px;" valign="bottom"></span>',
            pointFormat: '<span style="color:{point.color}; font-size:15px;">\u25cf</span> {series.name}: <b>{point.y}</b><br/>',
            shadow: !0,
            snap: Mb ? 25 : 10,
            style: {
                color: "#333333",
    ...
    ia.prototype = {
        ...
        init: function (a) {
            ...
            if ((this.input = a) && a.stops)
                this.stops = Ha(a.stops, function (a) {
                    return new ia(a[1])
                });
            else
        ...
        brighten: function (a) {
            ...
            if (this.stops)
                ...
                for (b = 0; b < 3; b++)
                    c[b] += F(a * 255), c[b] < 0 && (c[b] = 0), c[b] > 255 && (c[b] = 255);
            return this
        },
        ...
        align: function (a, b, c) {
            ...
            if (a) {
                if (this.alignOptions =
                        a, this.alignByTranslate = b, !c || ya(c))
                    this.alignTo = d = c || "renderer", ma(f, this), f.push(this), c = null
            } else
            ...
            if (!c) {
                ...
                if (d.isSVG) {
                    ...
                    if (za && i && i.fontSize === "11px" && e.toPrecision(3) === "16.9")
                        c.height = e = 14;
                    if (f)
                        c.width = P(e * aa(g)) + P(d * T(g)), c.height = P(e * T(g)) + P(d * aa(g))
                }
                if (t) {
                    for (; n.length > 250; )
                        delete l[n.shift()];
        ...
        shadow: function (a, b, c) {
            ...
            if (a) {
                ...
                for (e = 1; e <= i; e++) {
                    ...
                    if (c)
                        L(f, "height", s(L(f, "height") - h, 0)), f.cutHeight = h;
        ...
        zIndexSetter: function (a, b) {
            ...
            if (e) {
                ...
                for (i = 0; i < d.length && !h; i++)
                    if (e = d[i], f = L(e, "zIndex"), e !== g && (F(f) > a || !q(a) && q(f)))
    ...
    Q.prototype["stroke-widthSetter"] = Q.prototype.strokeSetter = function (a, b, c) {
        ...
        if (this.stroke && this["stroke-width"])
            this.strokeWidth = this["stroke-width"], Q.prototype.fillSetter.call(this, this.stroke, "stroke", c), c.setAttribute("stroke-width", this["stroke-width"]),
                    this.hasStroke = !0;
                        ...
                        if (e !== " ") {
                            ...
                            if (m) {
                                for (var n = e.replace(/([^\^])-/g, "$1- ").split(" "), X = g.length > 1 || f || n.length > 1 && j.whiteSpace !== "nowrap", o, w, q, s = [], v = y(r), B = 1, A = a.rotation, u = e, D = u.length;
                                        (X || t) && (n.length || s.length); )
                                    a.rotation = 0, o = a.getBBox(!0), q = o.width, !da && c.forExport && (q = c.measureSpanWidth(r.firstChild.data, a.styles)), o = q > m, w === void 0 && (w = o), t && w ? (D /= 2, u === "" || !o && D < 0.5 ? n = [] : (o && (w = !0), u = e.substring(0, u.length + (o ? -1 : 1) * ua(D)), n = [u + (m > 3 ? "\u2026" :
        ...
        label: function (a, b, c, d, e, f, g, h, i) {
            ...
            E = function () {
                var a = j.styles,
                        ...
                        c;
                c = h ? 0 : u;
                if (q(y) && n && (a === "center" || a === "right"))
                    b += {
                        center: 0.5,
                        right: 1
                    }[a] * (y - n.width);
                if (b !== m.x || c !== m.y)
                    m.attr("x", b), c !== B && m.attr("y", c);
                m.x = b;
                m.y = c
            };
            C = function (a, b) {
        ...
        var Cb = {
            ...
            color: function (a, b, c, d) {
                ...
                if (i) {
                    ...
                    if (c === "fill")
                        if (i === "gradient")
                            c = l.x1 || l[0] || 0, a = l.y1 || l[1] || 0, n = l.x2 || l[2] || 0, l = l.y2 || l[3] || 0, x = 'angle="' + (90 - V.atan((l - a) / (n - c)) * 180 / pa) + '"', ca();
                        else {
                            var k = l.r,
                                    s = k * 2,
                                    v = k * 2,
                    ...
                    f = ia(a), d[c + "-opacitySetter"](f.get("a"), c, b), k = f.get("rgb");
                else {
    ...
    Wa.prototype = {
        ...
        handleOverflow: function (a) {
            var b = this.axis,
                    ...
                    l, n = {};
            if (h)
                h < 0 && c - i * k < f ? l = A(c / T(h * ga) - f) : h > 0 && c + i * k > e && (l = A((d - c) / T(h * ga)));
            else if (d = c + (1 - i) * k, c - i * k < f ? j = a.x + j * (1 - i) - f : d > e && (j = e - a.x + j * i, m = -1), j = E(b.slotWidth, j), j < b.slotWidth && b.labelAlign === "center" && (a.x += m * (b.slotWidth - j - i * (b.slotWidth - E(k, j)))), k > j || b.autoRotation && g.styles.width)
                l = j;
            if (l) {
                n.width =
                        l;
        ...
        render: function (a, b, c) {
            ...
            if (l && y)
                w === "inside" && (y = -y), d.opposite && (y = -y), h = this.getMarkPath(u, v, y, l * A, g, f), n ? n.animate({
                    d: h,
                    opacity: c
            ...
            if (i && !isNaN(u))
                i.xy = v = this.getLabelPosition(u, v, i, g, j, s, a, q), this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !p(e.showLastLabel, 1) ? ca = !1 : g && !d.isRadial && !j.step && !j.rotation && !b && c !== 0 && this.handleOverflow(v), q && a % q && (ca = !1),
    ...
    ja.prototype = {
        ...
        init: function (a, b) {
            ...
            if (a.inverted && c && this.reversed === B)
                this.reversed = !0;
            this.removePlotLine =
            ...
            for (f in d)
                N(this, f, d[f]);
            if (this.isLog)
                this.val2lin = Ca, this.lin2val = la
        },
        ...
        defaultLabelFormatter: function () {
            ...
            if (h)
                ...
                for (; f-- && g === B; )
                    c = Math.pow(1E3, f + 1), a >= c && b * 10 % c === 0 && e[f] !== null && (g = u.numberFormat(b / c, -1) + e[f]);
                ...
                if (c.visible ||
                    ...
                    if (a.isXAxis) {
                        if (d = c.xData, d.length)
                            a.dataMin = E(p(a.dataMin, d[0]), Sa(d)), a.dataMax = s(p(a.dataMax, d[0]), Da(d))
                    } else {
                        c.getExtremes();
                        f = c.dataMax;
                        c = c.dataMin;
                        if (q(c) && q(f))
                            a.dataMin = E(p(a.dataMin, c), c), a.dataMax = s(p(a.dataMax, f), f);
                        if (q(e))
                            a.threshold = e;
        ...
        setAxisTranslation: function (a) {
            ...
            if (j || i || d)
                ...
                })), h = b.ordinalSlope && e ? b.ordinalSlope / e : 1, b.minPointOffset = f *= h, b.pointRangePadding = g *= h, b.pointRange = E(d, c), j)
        ...
        setTickInterval: function (a) {
            ...
            if (e)
                !a && E(b.min, p(b.dataMin, b.min)) <= 0 && Y(10, 1), b.min = fa(Ca(b.min), 15), b.max = fa(Ca(b.max), 15);
            if (b.range && q(b.max))
                b.userMin = b.min = y = s(b.min, b.minFromRange()), b.userMax = x = b.max, b.range = null;
            b.beforePadding && b.beforePadding();
            b.adjustForMinRange();
            if (!l && !b.axisPointRange && !b.usePercentage && !h && q(b.min) && q(b.max) && (c = b.max - b.min))
                !q(y) && k && (b.min -= c * k), !q(x) && i && (b.max += c * i);
            if (ka(d.floor))
                b.min = s(b.min, d.floor);
            if (ka(d.ceiling))
                b.max = E(b.max, d.ceiling);
            if (t && q(b.dataMin))
                if (n = n || 0, !q(y) && b.min < n && b.dataMin >= n)
                    b.min = n;
                else if (!q(x) && b.max > n && b.dataMax <= n)
                    b.max = n;
            ...
            if (!j && b.tickInterval < a)
                b.tickInterval = a;
            if (!f && !e && !j)
                b.tickInterval = tb(b.tickInterval, null, sb(b.tickInterval), p(d.allowDecimals, !(b.tickInterval > 0.5 && b.tickInterval < 5 && b.max > 1E3 && b.max < 9999)), !!this.tickAmount);
        ...
        setTickPositions: function () {
            ...
            if (!this.isLinked)
                this.trimTicks(b, e, f), this.min === this.max && q(this.min) && !this.tickAmount && (g = !0, this.min -= 0.5, this.max += 0.5), this.single = g, !c && !d && this.adjustTickAmount()
        },
        ...
        setScale: function () {
            ...
            if (b || a || this.isLinked || this.forceRedraw || this.userMin !== this.oldUserMin || this.userMax !== this.oldUserMax || this.alignToOthers()) {
                if (this.resetStacks && this.resetStacks(), this.forceRedraw = !1, this.getSeriesExtremes(), this.setTickInterval(),
                        this.oldUserMin = this.userMin, this.oldUserMax = this.userMax, !this.isDirty)
        ...
        renderUnsquish: function () {
                ...
                for (n = c.length; !f && n--; )
                    if (t = c[n], i = d[t].label)
                        if (i.styles.textOverflow === "ellipsis" && i.css({
                            textOverflow: "clip"
                        }), i.getBBox().height > this.len / c.length - (h.h - h.f) || d[t].labelLength > g)
                            i.specCss = {
            ...
            o(c, function (a) {
                var b = (a = d[a]) && a.label;
                if (b)
                    b.attr(k), m && b.css(D(m, b.specCss)), delete b.specCss, a.rotation = k.rotation
            });
        ...
        getOffset: function () {
            ...
            if (k || a.isLinked) {
                if (o(e, function (b) {
                    ...
                    X *= a.staggerLines, a.labelOffset = X * (a.opposite ? -1 : 1)
            } else
                for (v in f)
                    f[v].destroy(), delete f[v];
            if (t && t.text && t.enabled !== !1) {
                if (!a.axisTitle)
                    a.axisTitle = c.text(t.text, 0, 0, t.useHTML).attr({
                        zIndex: 7,
                        rotation: t.rotation ||
                                0,
                        align: t.textAlign || {
                ...
                if (j)
                    m = a.axisTitle.getBBox()[g ? "height" : "width"], l = t.offset, n = q(l) ? 0 : p(t.margin, g ? 5 : 10);
        ...
        render: function () {
            ...
            if (a.hasData() || f) {
                ...
                if (g.length && (o(g, function (b, c) {
                    if (!f || b >= a.min && b <= a.max)
                        i[b] || (i[b] = new Wa(a, b)), p && i[b].isNew && i[b].render(c, !0, 0.1), i[b].render(c)
                }),
                        n && (a.min === 0 || a.single)))
                    i[-1] || (i[-1] = new Wa(a, -1, null, !0)), i[-1].render(-1);
                l && o(g, function (c, d) {
                    s = g[d + 1] !== B ? g[d + 1] + n : a.max - n;
                    if (d % 2 === 0 && c < a.max && s <= a.max + (b.polar ? -n : n))
                        j[c] || (j[c] = new u.PlotLineOrBand(a)), w = c + n, j[c].options = {
                            from: e ? la(w) : w,
                            to: e ? la(s) : s,
                            color: l
            ...
            if (t)
                r = a.getLinePath(t), a.axisLine ? a.axisLine.animate({
                    d: r
        ...
        drawCrosshair: function (a, b) {
            var c, d = this.crosshair,
                    e, f;
            if (!this.crosshair || (q(b) || !p(d.snap, !0)) === !1 || b && b.series && b.series[this.coll] !== this)
                this.hideCrosshair();
            else if (p(d.snap, !0) ? q(b) && (c = this.isXAxis ? b.plotX : this.len - b.plotY) : c = this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos, c = this.isRadial ? this.getPlotLinePath(this.isXAxis ? b.x : p(b.stackY, b.y)) || null : this.getPlotLinePath(null, null, null, null, c) || null, c === null)
                this.hideCrosshair();
    ...
    ja.prototype.getTimeTicks = function (a, b, c, d) {
        ...
        if (q(b)) {
            ...
            if (k >= G.second)
                i[Hb](k >= G.minute ? 0 : j * S(i.getSeconds() / j));
            if (k >= G.minute)
                i[Ib](k >= G.hour ? 0 : j * S(i[ub]() / j));
            if (k >= G.hour)
                i[Jb](k >= G.day ? 0 : j * S(i[vb]() / j));
            if (k >= G.day)
                i[xb](k >= G.month ? 1 : j * S(i[$a]() / j));
            ...
            b = 1;
            if (rb || ib)
                i = i.getTime(), i = new oa(i + Za(i));
            h = i[bb]();
            for (var d = i.getTime(), m = i[ab](), l = i[$a](), n = (G.day + (g ? Za(i) : i.getTimezoneOffset() * 6E4)) % G.day; d < c; )
                e.push(d), k === G.year ? d = lb(h + b * j, 0) : k === G.month ? d = lb(h, m + b * j) : !g && (k === G.day || k === G.week) ? d = lb(h, m, l + b * j * (k === G.day ? 1 : 7)) : d += k * j, b++;
            e.push(d);
            o(Oa(e, function (a) {
    ...
    ja.prototype.getLogTickPositions = function (a, b, c, d) {
        ...
        if (a >= 0.5)
            a = A(a), g = this.getLinearTickPositions(a, b, c);
        else if (a >= 0.08)
            for (var f = S(b), h, i, k, j, m, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !m; f++) {
                i = e.length;
                for (h = 0; h < i && !m; h++)
                    k = Ca(la(f) * e[h]), k > b && (!d || j <= c) && j !== B && g.push(j), j > c && (m = !0), j = k
            }
                ...
                f) || 1)), a = tb(a, null, sb(a)), g = Ha(this.getLinearTickPositions(a, b, c), Ca), !d)
    ...
    Ya.prototype = {
        ...
        normalize: function (a, b) {
            ...
            if (!b)
                this.chartPosition = b = Bb(this.chart.container);
        ...
        runPointActions: function (a) {
            ...
            if (n && (n !== this.prevKDPoint || d && d.isHidden)) {
                ...
                } else if (d && d.refresh(n, a), !g || !g.directTouch)
                    n.onMouseOver(a);
                this.prevKDPoint = n
            } else
            ...
            if (!this._onDocumentMouseMove)
                this._onDocumentMouseMove = function (a) {
                    if (W[ra])
                        W[ra].pointer.onDocumentMouseMove(a)
        ...
        reset: function (a, b) {
            ...
            if (a)
                g.refresh(h), e && (e.setState(e.state, !0), o(c.axes, function (a) {
                ...
                g && g.hide(b);
                if (this._onDocumentMouseMove)
                    U(z, "mousemove", this._onDocumentMouseMove), this._onDocumentMouseMove =
                            null;
                o(c.axes, function (a) {
                    a.hideCrosshair()
                });
        ...
        setDOMEvents: function () {
            ...
            b.onmousemove = function (b) {
                a.onContainerClick(b)       //@@Custom add here to show the selected slice on mouse hover
    ...
    if (C.PointerEvent || C.MSPointerEvent) {
        var wa = {},
                ...
                Eb = function (a, b, c, d) {
                    if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && W[ra])
                        d(a), d = W[ra].pointer, d[b]({
                            type: c,
    ...
    pb.prototype = {
        init: function (a, b) {
            ...
            this.options = b;
            if (b.enabled)
                c.itemStyle = d, c.itemHiddenStyle =
        ...
        renderItem: function (a) {
            ...
            if (!o) {
                ...
                if (!this.baseline)
                    this.fontMetrics = c.fontMetrics(h.fontSize, o), this.baseline = this.fontMetrics.f + 3 + t, o.attr("y", this.baseline);
            ...
            if (e && this.itemX - r + f > (l || b.chartWidth - 2 * k - r - d.x))
                this.itemX = r, this.itemY += t + this.lastLineHeight +
        ...
        getAllItems: function () {
            ...
            o(this.chart.series, function (b) {
                var c = b.options;
                if (p(c.showInLegend, !q(c.linkedTo) ? B : !1, !0))
        ...
        handleOverflow: function (a) {
            var b = this,
                    ...
                    y = function (a) {
                        ...
                        if (b.contentGroup.div)
                            b.contentGroup.div.style.clip = "rect(" + t + "px,9999px," + (t + a) + "px,0)"
                    };
            ...
            if (a > f) {
                ...
                if (!i)
                    i = b.clipRect = d.clipRect(0, t, 9999, 0), b.contentGroup.clip(i);
                y(h);
                if (!l)
                    this.nav = l = d.g().attr({
                        zIndex: 1
                ...
                y(c.chartHeight), l.hide(), this.scrollGroup.attr({
                    translateY: 1
                }), this.clipHeight = 0;
            return a
        },
        scroll: function (a, b) {
            ...
            e > d && (e = d);
            if (e > 0)
                b !== B && Va(b, this.chart), this.nav.attr({
                    translateX: k,
    ...
    hb.prototype = {
        ...
        reflow: function (a) {
            ...
            if (!b.hasUserSize && !b.isPrinting && e && f && (c === C || c === z)) {
                if (e !== b.containerWidth || f !== b.containerHeight)
                    clearTimeout(b.reflowTimeout), b.reflowTimeout = Qa(function () {
                        if (b.container)
        ...
        setSize: function (a, b, c) {
            ...
            if (q(a))
                d.chartWidth = e = s(0, A(a)), d.hasUserSize = !!e;
            if (q(b))
                d.chartHeight = f = s(0, A(b));
            a = g.globalAnimation;
            (a ? Xa : M)(d.container, {
                width: e + "px",
                height: f + "px"
        ...
        drawChartBox: function () {
            ...
            if (j)
                f ? f.animate(x) : this.plotBackground = b.rect(p, o, q, y, 0).attr({
                    fill: j
                }).add().shadow(a.plotShadow);
            if (m)
                h ? h.animate(x) : this.plotBGImage = b.image(m, p, o, q, y).add();
            s ? s.animate({
                width: v.width,
                height: v.height
            }) : this.clipRect =
    ...
    Ia.prototype = {
        init: function (a, b, c) {
            ...
            if (a.options.colorByPoint && (b = a.options.colors || a.chart.options.colors,
                    this.color = this.color || b[a.colorCounter++], a.colorCounter === b.length))
                a.colorCounter = 0;
            a.chart.pointCount++;
            return this
        },
    ...
    R.prototype = {
        ...
        bindAxes: function () {
            ...
            o(a.axisTypes || [], function (e) {
                o(c[e], function (c) {
                    d = c.options;
                    if (b[e] === d.index || b[e] !== B && b[e] === d.id || b[e] === B && d.index === 0)
        ...
        autoIncrement: function () {
            ...
            if (d === "month" || d === "year")
                a = new oa(b), a = d === "month" ? +a[yb](a[ab]() + c) : +a[zb](a[bb]() + c), c = a - b;
            this.xIncrement = b + c;
            return b
        },
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData &&
                ...
                if (n && h > n) {
                    ...
                    if (ka(j)) {
                        ...
                        if (s)
                            for (c = 0; c < h; c++)
                                j = a[c], t[c] = j[0], r[c] = j.slice(1, s + 1);
                        else
                            for (c = 0; c < h; c++)
                                j = a[c], t[c] = j[0], r[c] = j[1];
                    else
                        Y(12)
                } else
                    for (c = 0; c < h; c++)
                        ...
                        e.pointClass.prototype.applyOptions.apply(j, [a[c]]), e.updateParallelArrays(j, c), l && q(j.name)))
                            m.names[j.x] = j.name;
                ya(r[0]) && Y(14, !0);
                e.data = [];
                e.options.data = a;
        ...
        generatePoints: function () {
            ...
            if (b && (g !== (c = b.length) || k))
                for (l = 0; l < c; l++)
                    if (l === h && !k && (l += g), b[l])
                        b[l].destroyElements(), b[l].plotX = B;
            this.data = b;
            this.points = m
        },
        ...
        translate: function () {
            ...
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, k = i === "between" || ka(i), j = a.threshold,
                ...
                if (b && this.visible && u && u[x])
                    o = this.getStackIndicator(o, x, this.index), u = u[x], w = u.points[o.key], n = w[0], w = w[1], n === m && (n = p(j, e.min)), e.isLog && n <= 0 && (n = null), y.total = y.stackTotal = u.total, y.percentage = u.total && y.y / u.total * 100,
                ...
                for (f = b.length; f--; )
                    if (g = b[f], d = S(g.plotX), e = g.plotY, j = g.graphic, n = g.marker || {}, o = !!g.marker, a = s && n.enabled === B || n.enabled, r = g.isInside, a && e !== B && !isNaN(e) && g.y !== null)
                        if (a = g.pointAttr[g.selected ? "select" : ""] || l, h = a.r, i = p(n.symbol, this.symbol), k = i.indexOf("url") === 0, j)
                            ...
                            if (r && (h > 0 || k))
                                g.graphic = c.renderer.symbol(i, d - h, e - h, 2 * h, 2 * h, o ? n : m).attr(a).add(q)
                        }
                    else if (j)
                        g.graphic =
                                j.destroy()
                ...
                for (; g--; ) {
                    ...
                    if (k) {
                        ...
                        if (!b.marker || j.negative && !f.fillColor && !e.fillColor)
                            f[a.pointAttrToOptions.fill] = f.color || !j.options.color && e[j.negative && h ? "negativeColor" : "color"] || ia(j.color).brighten(f.brightness || e.brightness).get();
                        f = {
                            color: j.color
                        };
                        if (!t)
        ...
        destroy: function () {
            ...
            o(a.axisTypes || [], function (b) {
                if (h = a[b])
                    ma(h.series, a), h.isDirty = h.forceRedraw = !0
            });
        ...
        render: function () {
            ...
            e && a.animate();
            if (!h)
                a.animationTimeout = Qa(function () {
                    a.afterAnimate()
                },
                        e);
    ...
    R.prototype.setStackedPoints = function () {
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            ...
            for (v = 0; v < d; v++) {
                ...
                l[q] || (l[q] = {});
                if (!l[q][w])
                    n[q] && n[q][w] ? (l[q][w] = n[q][w], l[q][w].total = null) : l[q][w] = new Kb(m, m.options.stackLabels, r, w, h);
                q = l[q][w];
    ...
    var sa = na(R, {
        ...
        getSegments: function () {
            ...
            if (this.options.stacking && !this.cropped) {
                ...
                R.prototype.getSegments.call(this), b = this.segments;
            this.segments = b
        },
        getSegmentPath: function (a) {
            var b =
    ...
    xa = na(R, {
        ...
        getColumnMetrics: function () {
            ...
            b.grouping === !1 ? h = 1 : o(a.chart.series, function (b) {
                ...
                if (b.type === a.type && b.visible && d.len === e.len && d.pos === e.pos)
                    c.stacking ? (f = b.stackKey, g[f] === B && (g[f] = h++), i = g[f]) : c.grouping !== !1 && (i = h++), b.columnIndex = i
            });
        ...
        drawPoints: function () {
            ...
            o(a.points, function (h) {
                var i = h.plotY,
                        k = h.graphic;
                if (i !== B && !isNaN(i) && h.y !== null)
                    f = h.shapeArgs, i = q(a.borderWidth) ? {
        ...
        animate: function (a) {
            var b = this.yAxis,
                    ...
                    e = {};
            if (da)
                a ? (e.scaleY = 0.001, a = E(b.pos + b.len, s(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len : e.translateY = a, this.group.attr(e)) : (e.scaleY = 1, e[d ? "translateX" : "translateY"] = b.pos, this.group.animate(e, this.options.animation), this.animate = null)
        },
        remove: function () {
            var a = this,
                    b = a.chart;
            ...
            setVisible: function (a, b) {
                ...
                if (a !== c.visible) {
                    ...
                    o(["graphic", "dataLabel", "connector", "shadowGroup"], function (b) {
                        /* //-- Disabled the link of legend text.
                         if (c[b]) c[b][a ? "show" :
                         "hide"
                         ](!0)
                         */
            ...
            a.dlProcessOptions && a.dlProcessOptions(d), k = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex ||
                ...
                if (n && !h)
                    ...
                    if (n)
                        ...
                        if (x.color === "contrast")
                            w.color = d.inside || d.distance < 0 || b.stacking ? j.getContrast(e.color || a.color) : "#000000";
                        if (c)
                            w.cursor = c;
                        for (r in n)
                            n[r] === B && delete n[r];
            ...
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                for (F = 2; F--; ) {
                    ...
                    if (L) {
                        ...
                        for (J = b = 0; !b && I[J]; )
                            b = I[J] && I[J].dataLabel && (I[J].dataLabel.getBBox().height || 21), J++;
                        if (l > 0) {
                            x = E(r + q + l, d.plotHeight);
                            for (J = s(0, r - q - l); J <= x; J += b)
                                H.push(J);
                            x = H.length;
                            if (L > x) {
                                c = [].concat(I);
                            ...
                            for (J = 0; J < L; J++) {
                                ...
                                var Q, O;
                                for (O = 0; O < x; O++)
                                    Q = P(H[O] - w[1]), Q < c && (c = Q, K = O);
                                if (K < J && H[J] !== null)
                                    K = J;
                                else
                                    for (x < L - J + K && H[J] !== null && (K = x - L + J); H[K] === null; )
                                        K++;
                                N.push({
                                    i: K,
                                    y: H[K]
                        ...
                        for (J = 0; J < L; J++) {
                            ...
                            c = w[1];
                            if (l > 0) {
                                if (x = N.pop(), K = x.i, C = x.y, c > C && H[K + 1] !== null || c < C && H[K - 1] !== null)
                                    C = E(s(0,
                                            c), d.plotHeight)
                            } else
                                C = c;
                ...
                if (Da(G) === 0 || this.verifyDataLabelOverflow(G))
                    this.placeDataLabels(), v && g && o(this.points, function (b) {
                        k = b.connector;
                        w = b.labelPos;
                        if ((u = b.dataLabel) && u._pos && b.visible)
                            D = u._attr.visibility, z = u.connX, C = u.connY, j = m ? ["M", z + (w[6] === "left" ? 5 : -5), C, "C", z, C, 2 * w[2] - w[4], 2 * w[3] - w[5], w[2], w[3], "L", w[4], w[5]] : ["M", z + (w[6] === "left" ? 5 : -5), C, "L", w[2], w[3], "L", w[4], w[5]], k ? (k.animate({
                                d: j
    ...
    (function (a) {
        ...
        b.prototype.hideOverlappingLabels = function (a) {
            ...
            for (e = 0; e < b; e++) {
                k = a[e];
                for (d = e + 1; d < b; ++d)
                    if (j = a[d], k && j && k.placed && j.placed && k.newOpacity !== 0 && j.newOpacity !== 0 && (m = k.alignAttr, l = j.alignAttr, n = 2 * (k.box ? 0 : k.padding), m = !(l.x > m.x + (k.width - n) || l.x + (j.width - n) < m.x || l.y > m.y + (k.height - n) || l.y + (j.height - n) < m.y)))
    ...
    if (I.column)
        xa.prototype.drawTracker = ea.drawTrackerPoint;
    if (I.pie)
        I.pie.prototype.drawTracker =
                ea.drawTrackerPoint;
    if (I.scatter)
        sa.prototype.drawTracker = ea.drawTrackerPoint;
    v(pb.prototype, {
    ...
    v(Ia.prototype, {
        select: function (a, b) {
            ...
            c.firePointEvent(a ? "select" : "unselect", {
                ...
                b || o(e.getSelectedPoints(), function (a) {
                    if (a.selected && a !== c)
                        a.selected = a.options.selected = !1, d.options.data[qa(a,
        ...
        setState: function (a, b) {
            ...
            if (!(a === this.state && !b || this.selected &&
                ...
                if (this.graphic)
                    g = g && this.graphic.symbolName && o.r, this.graphic.attr(D(o, g ? {
                        x: c - g,
                        y: d - g,
                        width: 2 * g,
                        height: 2 * g
                    ...
                    if (a && i)
                        if (g = i.radius, m = m.symbol || e.symbol, j && j.currentSymbol !== m && (j = j.destroy()), j)
                            ...
                            e.stateMarkerGraphic = j = l.renderer.symbol(m, c - g, d - g, 2 * g, 2 * g).attr(o).add(e.markerGroup), j.currentSymbol = m;
                    if (j)
                ...
                if ((c = f[a] && f[a].halo) && c.size) {
                    if (!n)
                        e.halo = n = l.renderer.path().add(l.seriesGroup);
                    n.attr(v({
